    ...
    <>
      ...
      <div className="mx-auto max-w-3xl px-4 py-10 md:py-14">
        ...
        <p className="mt-4 text-sm leading-loose text-steel-700">
          {SITE_NAME}は、「売る前の5分で読む、中立のカメラ・レンズ買取ナビ」をコンセプトに、フィルムカメラ・オールドレンズ・デジタル一眼・壊れたカメラの買取サービスの条件（買取方法・対応エリア・査定料・出張料・送料・返送料・入金・キャンセル規定・故障品の受付・遺品や大量への対応・運営会社情報）を各社公式サイトで一次確認し、確認日つきで整理して提供する情報サイトです。あわせて、価値の見分け方や遺品のカメラの売り方、出張買取のクーリングオフ制度を一般知識として解説します。特定の業者への申し込みを強制するものではなく、売却の判断材料を提供することを目的としています。
        </p>
